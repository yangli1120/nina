...
public class DialogUtils {
    ...
    public static class SimpleButtonAction implements ButtonAction {
        @Override
    ...
    public static void showDialog(@NonNull Activity activity, @NonNull Dialog dialog) {
        dialog.setOwnerActivity(activity);
        if (!Utils.isNull(dialog.getOwnerActivity()) && !dialog.getOwnerActivity().isFinishing())
            dialog.show();
    }
